...
import bot.database.jooq.Indexes;
...
public class FlywaySchemaHistory extends TableImpl<FlywaySchemaHistoryRecord> {
     ...
     */
    public final TableField<FlywaySchemaHistoryRecord, String> INSTALLED_ON = createField(
            DSL.name("installed_on"),
            SQLDataType.CLOB
                    .nullable(false)
                    .defaultValue(DSL.field(DSL.raw("strftime('%Y-%m-%d %H:%M:%f','now')"), SQLDataType.CLOB)),
            this,
            "");
    ...
    private FlywaySchemaHistory(
            Name alias, Table<FlywaySchemaHistoryRecord> aliased, Field<?>[] parameters, Condition where) {
